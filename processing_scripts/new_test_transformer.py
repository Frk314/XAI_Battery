...
from model_utils import make_transformer_model
...
#%%
model = make_transformer_model(input_shape=(100, 100))
print(model.summary())

for n in range(1, 2):
    model_name = f'transformers_{n}'
    mdir = f'./new_transformer_models/{dataset_name}/'
    rdir = './new_transformer_results/'
